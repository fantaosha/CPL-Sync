 ...
 * will be used in the CPL-Sync algorithm.
 *
...
/** Some useful typedefs for the CPL-Sync library */
...
enum class Formulation {
   ...
   *  translational states from the estimation (cf. Problem 4 in the CPL-Sync
   * tech report).
   */
  Simplified,
   ...
   * translational states (cf. Problem 2 in the CPL-Sync tech report).
   */
  Explicit
};
